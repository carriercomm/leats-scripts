...
if ($ARGV[0] eq "ALL" )
{
	@files=("/leats-scripts/01-boot/1.pl",
		...
		"/leats-scripts/06-rights/2.pl",
		"/leats-scripts/06-rights/3.pl",
		"/leats-scripts/06-rights/4.pl",
		"/leats-scripts/06-rights/5.pl",
	        "/leats-scripts/06-rights/6.pl",
		"/leats-scripts/07-nfs/1.pl",
                "/leats-scripts/07-nfs/2.pl",
                "/leats-scripts/07-nfs/3.pl",
                "/leats-scripts/07-nfs/4.pl",
		"/leats-scripts/12-system/1.pl",
		"/leats-scripts/12-system/2.pl",
		"/leats-scripts/12-system/3.pl",
		"/leats-scripts/12-system/4.pl",
		"/leats-scripts/12-system/5.pl",
		"/leats-scripts/12-system/6.pl",
		"/leats-scripts/12-system/7.pl",
		"/leats-scripts/12-system/8.pl",
