...
our $hint="Have you checked if the sshd is running? (service)";
#
#
#
#############
...
sub break() {
	...
	my $ssh=Framework::ssh_connect;
        my $output=$ssh->capture('service sshd stop');
...
sub grade() {
	...
	printS("ssh is working:","$L");
	Framework::grade(Framework::timedconTo(10,"1.1.1.2","22"));
