...
cat /tmp/server_disk/etc/grub.conf | sed 's/vmlinux/vmlinuz/g' > /tmp/grubtmp123.txt; cat /tmp/grubtmp123.txt > /tmp/server_disk/etc/grub.conf; rm -f /tmp/grubtmp123.txt; 
