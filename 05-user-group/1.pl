...
- Create a user named ronald.
- Create a group homegroup.";

our $hint="Create the user and the group. (useradd, groupadd)";
#
#
#
#############
...
sub grade() {
	...
	printS("User ronald exist","$L");
	Framework::grade(UserGroup::userExist("ronald"));

	printS("Group homegroup exist","$L");
	Framework::grade(UserGroup::groupExist("homegroup"));
