...
Update 'man' to version 1.6f-32.el6.
...
";
our $hint="Update the package. (rpm or yum)";
#
#
#
#############
...
sub grade() {
	...
	cryptText2File("<ROOT>$USERDATA<DATE>$now</DATE><TOPIC>$topic</TOPIC><PROBLEM>$problem</PROBLEM><DESCRIPTION>$description</DESCRIPTION>","$result_file");
        ...
        printS("Checking man has been updated","$L");
        Framework::grade(Packages::CheckPackageInstalled("man","1.6f-32.el6"));
